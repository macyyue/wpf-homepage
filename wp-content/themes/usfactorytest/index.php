...
get_header(); ?>
<link rel="stylesheet" href="/commontest/css/slide.css">
<div class="topTitle">
  <h1>建築・建設業のお悩みをDXで解決します!!</h1>
</div>
<!--スライドショー-->
<div class="mainimg">
  <div><img src="/commontest/img/homepage/top-page_01.png" alt="" /></div>
  <div><img src="/commontest/img/homepage/top-page_02.png" alt="" /></div>
  <div><img src="/commontest/img/homepage/top-page_03.png" alt="" /></div>
  <div><img src="/commontest/img/homepage/top-page_04.png" alt="" /></div>
</div>
<!-- 追加 -->
 <div id="container">
 <main>
    ...
    <section>
      ...
      <div class="list-container">
        <div class="list blur">
          <figure>
            <img
              loading="lazy"
              decoding="async"
              src="/commontest/img/homepage/top-page_BIforAC_01.png" alt="">
          </figure>
          <div class="text">
        ...
        <div class="list blur">
          <figure>
            <img src="/commontest/img/homepage/top-page_BIforAC_mokuzo_01.png"
              alt=""
              loading="lazy"
              decoding="async">
          </figure>
        ...
        <div class="list blur">
          <figure><img src="/commontest/img/homepage/top-page_Info360_01.png"
              alt=""
              loading="lazy"
              decoding="async">
          </figure>
        ...
        <div class="list blur">
          <figure><img src="/commontest/img/homepage/top-page_tengun_01.png"
              alt=""
              loading="lazy"
              decoding="async">
          </figure>
        ...
        <h2>Information<span>会社情報</span></h2>
          ...
          <address class="box">
              ...
              <a href="/inquiry/" target="_blank">
                <img src="commontest/img/banner_campaign_AI-Structure_20241010.png" />
              </a>
            ...
            <ul class="submenu">
              <li><a href="/recruit/interview01/">トップメッセージ<span>Top message</span></a></li>
    ...
    document.querySelectorAll("a").forEach(link => {
        link.addEventListener("click", function (event) {
            ...
            if (window.location.search.includes("preview=true")) {
                ...
                window.location.href = url.origin + url.pathname; // 确保正确跳转
            }
        });
    });
});
...
<script src="/commontest/js/slick.js"></script>
<!--パララックス（inview）-->
