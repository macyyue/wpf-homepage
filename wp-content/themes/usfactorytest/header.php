...
<head>
  ...
  <link rel="icon" href="/commontest/img/Usfactory_Mark_500px.png" type="image/x-icon">
  ...
  <script type="text/javascript" src="/commontest/js/commontest.js"></script>
...
<body <?php body_class(); ?>>
  ...
  <header>
    <a
      ...
      <img
        src="/commontest/img/us-logo-black.svg"
        alt="株式会社U's Factory"
        data-astro-cid-3ef6ksr2 />
    </a>
    ...
    <div
      ...
      <nav data-astro-cid-ttztgwaq>
        <ul data-astro-cid-ttztgwaq class="dropmenu">
          ...
          <li data-astro-cid-ttztgwaq>
            <a href="/info360/" class="nav_link" data-astro-cid-ttztgwaq>Info360
            </a>
          </li>
          <li data-astro-cid-ttztgwaq class="has-submenu">
            <a href="#" class="dropdowns" data-astro-cid-ttztgwaq>BI for AC
            </a>
          ...
          <li data-astro-cid-ttztgwaq>
            <a href="/access/" class="nav_link" data-astro-cid-ttztgwaq>ACCESS
            </a>
          </li>
          <li data-astro-cid-ttztgwaq>
            <a href="/company/" class="nav_link" data-astro-cid-ttztgwaq>会社概要
            </a>
          </li>
          <li data-astro-cid-ttztgwaq>
            <a href="/recruit/" class="nav_link" data-astro-cid-ttztgwaq>採用情報
            </a>
          </li>
          <li data-astro-cid-ttztgwaq>
            <a
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const submenu = submenuItem.querySelector('.dropmenuCon');
